...
//question no.29
const favourite_fruits = ["apple", "banana", "orange", "grapes"];
...
if (favourite_fruits.includes("orange")) {
    console.log("oranges are favourite");
}
;
if (favourite_fruits.includes("grape")) {
    console.log("grapes are sour");
}
;
...
greetusers();
//Question no.31
let usserNames = ['faiza', 'Maria', 'Kinza'];
function greetUssers(usserNames) {
...
//Question no.32
//array
const current_users = ["meerab", "maham", "mishaal"];
const new_users = ["kiran", "fariha", "sadia"];
//function
function checkUserNames(current_users, new_users) {
    ...
    for (const newUser of new_users) {
        ...
        if (lowercasedCurrentUsers.includes(lowercasedCurrentUsers)) {
            ...
            console.log(`Username "${newUser}" is already available`);
        }
    }
}
//test function
