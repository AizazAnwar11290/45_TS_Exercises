...
//Question no.1
// To install Node.js, TypeScript, and VS Code on your computer, follow these steps:

// 1. Node.js: Download the installer from nodejs.org and follow the installation prompts.
// 2. 
// TypeScript: After installing Node.js, open a terminal and run npm install -g typescript.

// 3. VS Code: Download and install Visual Studio Code from code.visualstudio.com.
// These steps will set up your environment for TypeScript development.



//question No.2
let personname:string=("Ibraheem")
console.log(`hello Eric,would you like to learn some python today? ${personname}`)

//Question no.3
let personnamee:string=(" muhammad ismaeel aizaz").toUpperCase()
console.log(personnamee)

let apersonname:string=("Aizaz Anwar").toLowerCase()
...
let words: string[] = personnamee.split("  ");
...
//question no.4
let quote:string='"Have good hopes but prepare according to bad circumstances."'
console.log(`once Quaid said,${quote}`);

//question n0.5
let perrsonname:string ="Imran khan"
let message:string= perrsonname  +  "ap ne gahbrana ni hai"
console.log(message)

//question no.6

let aname:string="\t  moiz  \n"

console.log(aname)

let strippedname:string=aname.trim()
console.log(strippedname)

//questuon no.7

function minfunc(a:number,b:number){
  console.log(a-b) 
}
minfunc(16,8)

function addfunc(d:number, e:number){
  console.log(d+e)
}
addfunc(4,4)
 
function multiplication(q:number,r:number){console.log(
  q*r
)}
multiplication(4,2)

function division(s:number,p:number){console.log(
  s/p)}
division(16,2)
...
//question no.11
let friend1:string="Ayesha"
let friend2:string="Alisha"
let friend3:string="Umaira"
...
//Question no.13
let favtrans:Array<[trans:string,brand:string]>=[]
...
//4th step
let newguestlist:string="Shakeel"
...
guestlist.pop()
guestlist.pop()
console.log(`uestlist after removing last 2 persons: ${guestlist}`)
...
if (age<2){
 ...
 else  if(age<65){console.log("ther person is a adult")}
else{
  console.log("the person is elder ")}

  //question no.20
  const lanuages:string[]=["Urdu","English","Spsnich", "French","japanese"]
  ...
  bouquets.push({
    name:"summerbloom",
    price:350,
    description:"beautiful flowers of summer"
  })

  let bouquet2={
    name:" red rose",
    price:150,
    description:"beautifil rose "
  }
...
console.log(bouquets);
  ...
  function mobiles(name:string,model:string){
    return{
      name,
      model,
...
if(allien_colour== 'green'){console.log
  "then player just earned 5 points"
}else{
console.log("the player has just got 10 points")}

if(allien_colour=='blue'){console.log("the player has got 15 points ")
}else(console.log("the player has got 20 points"))

//question no.27

let allienn_colour:string='green'
...
else if(allienn_colour==='red'){"yhe player has got 15 points"}
else(console.log("what is the actual colour of allien "))
...
else if(allienn_colour==='red'){console.log("yhe player has got 15 points")}
...
let aage=26
if (aage<2){console.log("the person is baby")}

else if(aage<4){console.log("the person ia atoddler")}

else if(aage<13){console.log("the person ia a kid")}

 else if(aage<20){console.log("the person is a teenager")}

 else if(age <65){console.log("the person ia an adult")}
 
 else ("the person in an elder")

 //question no.29
 
 
 const favourite_fruits:string[]=["apple", "banana", "orange","grapes"];

 if(favourite_fruits.includes("apple")){console.log("i like apples")};
 if(favourite_fruits.includes("banana")){console.log("i enjoy bananas")};
 if(favourite_fruits.includes("orange")){console.log("oranges are favourite")};
 if(favourite_fruits.includes("grape")){console.log("grapes are sour")};
 if(favourite_fruits.includes("mango")){console.log(" king of fruits")};


 let a =favourite_fruits.includes("banana")
 console.log(a)
 ...
 const usernames:string[]=["Aqsa" , "Fazia", "Samia", "Amina", "Admin"]
...
let usserNames:string[]=['faiza','Maria','Kinza'];

function greetUssers(usserNames:string[]):void{
  if(usserNames.length===0){
    console.log("we need to find some users"); return;}


for(const usserName of usserNames){
  if(usserName.toLowerCase()==='Maria'){
    console.log('hi maria,would you like to drink tea?');
  }
  else{
    console.log(`hi ${usserName} thankyou so much.`);
  }}
}
console.log(`for non empty usserName:\n`);

greetUssers(usserNames);
...
//array
const current_users:string[]=["meerab","maham","mishaal"];
const new_users:string[]=["kiran","fariha","sadia"];
...
function checkUserNames(current_users:string[],new_users:string[]):void
{
  ...
  for (const newUser of new_users){
    const lowercasedCurrentUsers= newUser.toLocaleLowerCase();
    ...
    else{console.log(`Username "${newUser}" is already available`);}
    }
  }
  //test function
...
const pizzas:string[]=[ "periperi" ,"chicken supreme" ,"chicken tikka"]
...
const animals:string[]=["Rabbit","dog","cat"]
...
for(const animal of animals){
    if (animal === 'dog'){
        ...
        else if(animal==='cat'){console.log(`a ${animal} is also a good pet`)}
}
...
let Message:string="nothing to say"
...
function makeShirt(size:string="large",messagee:string="do you love typescript?"):void
{
...
const  city_Country=(city:string , country:string = 'unknown country')=>{
...
// It does not include track number
function make_album1(artistName:string,albumTitle:string) {
    return{artistName,albumTitle}
 }

let album1 =make_album1("Artist1","PSL Anthem")
let album2 =make_album1("Artist2","National Anthem")
let album3 =make_album1("Artist3","National Cricket Anthem")
console.log(album1);
console.log(album2);
 console.log(album3);
...
let album4 =make_album2("Artist1","PSL Anthem",20)
let album5 =make_album2("Artist2","National Anthem",10)
let album6 =make_album2("Artist3","National Cricket Anthem",15)
console.log(album4);
console.log(album5);
console.log(album6);
...
//Question no.41
const magicianNames:string[]=["cris angle", "shin lim", "dynamo","pen and teller","david copperfield"]
...
const magicianName:string[]=["cris angle", "shin lim", "dynamo","pen and teller","david copperfield"]
...
function show_magician(magicians:string[]):void{
  for (const magician of magicians){
    ...
    console.log("\nGreat Magicians:");
    show_magician(greatmagicianNames)
...
function showmagicians(magicians:string[]):void{
  for (const magician of magicians){
    ...
    //Exercise # 45
    function creatcar(
      manufacture:string,model:string,...
